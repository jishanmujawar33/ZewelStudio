    ...
    <div className="bg-white min-h-screen">
      ...
      <section className="relative h-[60vh] min-h-[400px] flex items-center justify-center text-center px-6">
        ...
        <div className="relative z-10 max-w-3xl pt-20">
          ...
          <p className="text-[#4b5563] text-lg mt-6">A legacy of craftsmanship, trust, and unparalleled artistry in lab-grown diamonds.</p>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-[#4b5563] leading-relaxed mb-6 text-lg mt-6">
              Founded with a passion for exquisite design and uncompromising quality, Zewel Studio has become a landmark for fine jewellery in Mumbai. We bring a unique perspective to every piece we create—understanding that jewellery is profoundly personal.
            </p>
