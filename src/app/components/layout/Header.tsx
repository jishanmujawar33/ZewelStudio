      ...
      <div className={`bg-[#f0f4f8] transition-all duration-300 overflow-hidden ${scrolled ? "h-0" : "h-10"}`}>
        <div className="max-w-7xl mx-auto px-6 h-full flex items-center justify-between">
          ...
          <div className="flex items-center gap-5">
            ...
            <a href="tel:+919136193999" className="flex items-center gap-2 text-[#6b7280] hover:text-[#2563eb] text-[10px] font-medium tracking-widest transition-colors">
              <Phone size={12} />
              +91 913619 3999
            </a>
          </div>
          ...
          <div className="flex justify-between md:grid md:grid-cols-3 items-center h-full">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              >
                <Link 
                  to="/collections" 
                  className="flex items-center gap-1 text-white/80 hover:text-white text-[11px] tracking-widest uppercase font-medium transition-colors py-8"
                >
                  Collections <ChevronDown size={14} className={`transition-transform duration-300 ${dropdownOpen ? "rotate-180" : ""}`} />
                </Link>
                
                {/* Dropdown menu */}
                <div className={`absolute top-[100%] left-0 w-64 bg-white shadow-xl border border-[#e5e7eb] rounded-sm overflow-hidden transition-all duration-300 origin-top ${dropdownOpen ? "opacity-100 scale-100 visible" : "opacity-0 scale-95 invisible"}`}>
                  <div className="py-2">
                    <Link 
                      to="/collections"
                      className="block px-6 py-3 text-[13px] text-[#163275] font-semibold hover:bg-[#f0f4f8] transition-colors border-b border-[#e5e7eb]"
                    >
            ...
            <div className="flex items-center justify-end gap-6 ml-auto md:ml-0">
              <a 
                ...
                className="hidden md:block text-white/80 hover:text-white text-[11px] tracking-widest uppercase font-medium transition-colors cursor-pointer"
              >
                Contact Us
              </a>
        ...
        <div className="md:hidden absolute top-full left-0 right-0 bg-white border-b border-[#e5e7eb] shadow-lg max-h-[calc(100vh-120px)] overflow-y-auto">
          <div className="px-6 py-6 flex flex-col gap-4">
            ...
            <a 
              ...
              className="text-[#1f2937] text-sm uppercase tracking-wider font-semibold border-b border-[#f3f4f6] pb-3"
            >
              Contact Us
            </a>
            ...
            <div className="pt-2">
              ...
              <Link to="/collections" className="text-[#163275] text-sm font-semibold block mb-3 pl-2">View All Collections →</Link>
