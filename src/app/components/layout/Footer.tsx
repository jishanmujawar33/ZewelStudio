      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8 mb-16">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed mb-6">
              Zewel Studio is Borivali's finest luxury jewellery showroom — built on a belief that jewellery is memory, identity, and art.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/collections" className="text-sm hover:text-white transition-colors">All Collections</Link></li>
              <li><a href="/#services" onClick={handleHashLink("services")} className="text-sm hover:text-white transition-colors cursor-pointer">Services</a></li>
              <li><a href="/#contact" onClick={handleHashLink("contact")} className="text-sm hover:text-white transition-colors cursor-pointer">Contact Us</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3">
                ...
                <a href="tel:+919136193999" className="text-sm hover:text-white transition-colors">+91 913619 3999</a>
              </li>
              <li className="flex items-center gap-3">
              ...
              <li className="flex items-start gap-3 pt-2">
                ...
                <span className="text-sm">Tue-Sun: 11 AM - 9 PM</span>
              </li>
            </ul>
          </div>
        ...
        <div className="border-t border-white/10 pt-8 flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
          <p className="text-[10px] tracking-widest uppercase">
            © 2026 Zewel Studio Private Limited. All Rights Reserved.
          </p>
